...
import (
	...
	storageDefault "github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure/storage"
...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		cfg := config.New(ctx, "")
		storageAccountName := randomSuffix.Result
		...
		staticWebsite, err := storageDefault.NewStorageAccountStaticWebsite(ctx, "staticWebsite", &storageDefault.StorageAccountStaticWebsiteArgs{
		...
		// Upload the files
		blobTypeBlock := storageDefault.BlobTypeBlock
		_, err = storageDefault.NewBlob(ctx, "index_html", &storageDefault.BlobArgs{
		...
		_, err = storageDefault.NewBlob(ctx, "notfound_html", &storageDefault.BlobArgs{
